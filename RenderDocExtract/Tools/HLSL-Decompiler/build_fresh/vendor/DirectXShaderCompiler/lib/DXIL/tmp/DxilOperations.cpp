...
const OP::OpCodeProperty OP::m_OpCodeProps[(unsigned)OP::OpCode::NumOpCodes] = {
  ...
  // Unary float
  {  OC::FAbs,                    "FAbs",                     OCC::Unary,                    "unary",                     Attribute::ReadNone , 1, {{0x407}}       , {{0x7}}          }, // Overloads: hfd<hfd
  {  OC::Saturate,                "Saturate",                 OCC::Unary,                    "unary",                     Attribute::ReadNone , 1, {{0x407}}       , {{0x7}}          }, // Overloads: hfd<hfd
  ...
  // Unary int
  {  OC::Bfrev,                   "Bfrev",                    OCC::Unary,                    "unary",                     Attribute::ReadNone , 1, {{0x4e0}}       , {{0xe0}}         }, // Overloads: wil<wil
  ...
  // Tertiary float
  {  OC::FMad,                    "FMad",                     OCC::Tertiary,                 "tertiary",                  Attribute::ReadNone , 1, {{0x407}}       , {{0x7}}          }, // Overloads: hfd<hfd
  {  OC::Fma,                     "Fma",                      OCC::Tertiary,                 "tertiary",                  Attribute::ReadNone , 1, {{0x404}}       , {{0x4}}          }, // Overloads: d<d

  // Tertiary int
  {  OC::IMad,                    "IMad",                     OCC::Tertiary,                 "tertiary",                  Attribute::ReadNone , 1, {{0x4e0}}       , {{0xe0}}         }, // Overloads: wil<wil

  // Tertiary uint
  {  OC::UMad,                    "UMad",                     OCC::Tertiary,                 "tertiary",                  Attribute::ReadNone , 1, {{0x4e0}}       , {{0xe0}}         }, // Overloads: wil<wil
  ...
  {  OC::HitObject_TraceRay,      "HitObject_TraceRay",       OCC::HitObject_TraceRay,       "hitObject_TraceRay",        Attribute::None     , 1, {{0x100}}       , {{0x0}}          }, // Overloads: u
  {  OC::HitObject_FromRayQuery,  "HitObject_FromRayQuery",   OCC::HitObject_FromRayQuery,   "hitObject_FromRayQuery",    Attribute::ReadOnly , 0, {}              , {}               }, // Overloads: v
  {  OC::HitObject_FromRayQueryWithAttrs, "HitObject_FromRayQueryWithAttrs", OCC::HitObject_FromRayQueryWithAttrs, "hitObject_FromRayQueryWithAttrs", Attribute::ReadOnly , 1, {{0x100}}       , {{0x0}}          }, // Overloads: u
  ...
  {  OC::HitObject_Invoke,        "HitObject_Invoke",         OCC::HitObject_Invoke,         "hitObject_Invoke",          Attribute::None     , 1, {{0x100}}       , {{0x0}}          }, // Overloads: u
  {  OC::MaybeReorderThread,      "MaybeReorderThread",       OCC::MaybeReorderThread,       "maybeReorderThread",        Attribute::None     , 0, {}              , {}               }, // Overloads: v
  {  OC::HitObject_IsMiss,        "HitObject_IsMiss",         OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x8}}         , {{0x0}}          }, // Overloads: 1
  {  OC::HitObject_IsHit,         "HitObject_IsHit",          OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x8}}         , {{0x0}}          }, // Overloads: 1
  {  OC::HitObject_IsNop,         "HitObject_IsNop",          OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x8}}         , {{0x0}}          }, // Overloads: 1
  {  OC::HitObject_RayFlags,      "HitObject_RayFlags",       OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x40}}        , {{0x0}}          }, // Overloads: i
  {  OC::HitObject_RayTMin,       "HitObject_RayTMin",        OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_RayTCurrent,   "HitObject_RayTCurrent",    OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_WorldRayOrigin, "HitObject_WorldRayOrigin", OCC::HitObject_StateVector,    "hitObject_StateVector",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_WorldRayDirection, "HitObject_WorldRayDirection", OCC::HitObject_StateVector,    "hitObject_StateVector",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_ObjectRayOrigin, "HitObject_ObjectRayOrigin", OCC::HitObject_StateVector,    "hitObject_StateVector",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_ObjectRayDirection, "HitObject_ObjectRayDirection", OCC::HitObject_StateVector,    "hitObject_StateVector",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_ObjectToWorld3x4, "HitObject_ObjectToWorld3x4", OCC::HitObject_StateMatrix,    "hitObject_StateMatrix",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_WorldToObject3x4, "HitObject_WorldToObject3x4", OCC::HitObject_StateMatrix,    "hitObject_StateMatrix",     Attribute::ReadNone , 1, {{0x2}}         , {{0x0}}          }, // Overloads: f
  {  OC::HitObject_GeometryIndex, "HitObject_GeometryIndex",  OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x40}}        , {{0x0}}          }, // Overloads: i
  {  OC::HitObject_InstanceIndex, "HitObject_InstanceIndex",  OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x40}}        , {{0x0}}          }, // Overloads: i
  {  OC::HitObject_InstanceID,    "HitObject_InstanceID",     OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x40}}        , {{0x0}}          }, // Overloads: i
  {  OC::HitObject_PrimitiveIndex, "HitObject_PrimitiveIndex", OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x40}}        , {{0x0}}          }, // Overloads: i
  {  OC::HitObject_HitKind,       "HitObject_HitKind",        OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x40}}        , {{0x0}}          }, // Overloads: i
  {  OC::HitObject_ShaderTableIndex, "HitObject_ShaderTableIndex", OCC::HitObject_StateScalar,    "hitObject_StateScalar",     Attribute::ReadNone , 1, {{0x40}}        , {{0x0}}          }, // Overloads: i
  {  OC::HitObject_SetShaderTableIndex, "HitObject_SetShaderTableIndex", OCC::HitObject_SetShaderTableIndex, "hitObject_SetShaderTableIndex", Attribute::ReadNone , 0, {}              , {}               }, // Overloads: v
  {  OC::HitObject_LoadLocalRootTableConstant, "HitObject_LoadLocalRootTableConstant", OCC::HitObject_LoadLocalRootTableConstant, "hitObject_LoadLocalRootTableConstant", Attribute::ReadOnly , 0, {}              , {}               }, // Overloads: v
  {  OC::HitObject_Attributes,    "HitObject_Attributes",     OCC::HitObject_Attributes,     "hitObject_Attributes",      Attribute::ArgMemOnly, 1, {{0x100}}       , {{0x0}}          }, // Overloads: u
  ...
  {  OC::MatVecMul,               "MatVecMul",                OCC::MatVecMul,                "matVecMul",                 Attribute::ReadOnly , 2, {{0x400},{0x400}}, {{0x63},{0x63}}  }, // Overloads: <hfwi,<hfwi
  {  OC::MatVecMulAdd,            "MatVecMulAdd",             OCC::MatVecMulAdd,             "matVecMulAdd",              Attribute::ReadOnly , 2, {{0x400},{0x400}}, {{0x63},{0x63}}  }, // Overloads: <hfwi,<hfwi
  ...
  switch (opCode) { // return     opCode
                    // OPCODE-OLOAD-FUNCS:BEGIN
                      ...
                      case OpCode::ReservedA2:             A(pV);       A(pI32); break;
                        ...
                        // Shader Execution Reordering
                      case OpCode::HitObject_TraceRay:     A(pHit);     A(pI32); A(pRes); A(pI32); A(pI32); A(pI32); A(pI32); A(pI32); A(pF32); A(pF32); A(pF32); A(pF32); A(pF32); A(pF32); A(pF32); A(pF32); A(udt);  break;
                      case OpCode::HitObject_FromRayQuery: A(pHit);     A(pI32); A(pI32); break;
                      case OpCode::HitObject_FromRayQueryWithAttrs:A(pHit);     A(pI32); A(pI32); A(pI32); A(udt);  break;
                      ...
                      case OpCode::HitObject_Invoke:       A(pV);       A(pI32); A(pHit); A(udt);  break;
                      case OpCode::MaybeReorderThread:     A(pV);       A(pI32); A(pHit); A(pI32); A(pI32); break;
                      case OpCode::HitObject_IsMiss:       A(pI1);      A(pI32); A(pHit); break;
                      case OpCode::HitObject_IsHit:        A(pI1);      A(pI32); A(pHit); break;
                      case OpCode::HitObject_IsNop:        A(pI1);      A(pI32); A(pHit); break;
                      case OpCode::HitObject_RayFlags:     A(pI32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_RayTMin:      A(pF32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_RayTCurrent:  A(pF32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_WorldRayOrigin:A(pF32);     A(pI32); A(pHit); A(pI32); break;
                      case OpCode::HitObject_WorldRayDirection:A(pF32);     A(pI32); A(pHit); A(pI32); break;
                      case OpCode::HitObject_ObjectRayOrigin:A(pF32);     A(pI32); A(pHit); A(pI32); break;
                      case OpCode::HitObject_ObjectRayDirection:A(pF32);     A(pI32); A(pHit); A(pI32); break;
                      case OpCode::HitObject_ObjectToWorld3x4:A(pF32);     A(pI32); A(pHit); A(pI32); A(pI32); break;
                      case OpCode::HitObject_WorldToObject3x4:A(pF32);     A(pI32); A(pHit); A(pI32); A(pI32); break;
                      case OpCode::HitObject_GeometryIndex:A(pI32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_InstanceIndex:A(pI32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_InstanceID:   A(pI32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_PrimitiveIndex:A(pI32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_HitKind:      A(pI32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_ShaderTableIndex:A(pI32);     A(pI32); A(pHit); break;
                      case OpCode::HitObject_SetShaderTableIndex:A(pHit);     A(pI32); A(pHit); A(pI32); break;
                      case OpCode::HitObject_LoadLocalRootTableConstant:A(pI32);     A(pI32); A(pHit); A(pI32); break;
                      case OpCode::HitObject_Attributes:   A(pV);       A(pI32); A(pHit); A(udt);  break;
